...
public class ProfileService {
    ...
    public User saveProfile(Long userId, ProfileSaveRequest request) {
        ...
        // Update food preferences (optional fields)
        ...
        if (request.getDislikedFoods() != null) {
            user.setDislikedFoods(request.getDislikedFoods());
        }
        if (request.getMaxBudgetPerDay() != null) {
            user.setMaxBudgetPerDay(request.getMaxBudgetPerDay());
        }
        if (request.getMaxCookingTimePerMeal() != null) {
            user.setMaxCookingTimePerMeal(request.getMaxCookingTimePerMeal());
        }
    ...
    private ProfileResponseDTO createProfileFromUser(User user) {
        ...
        // Food Preferences
        profile.setDietaryPreference(user.getDietaryPreference());
        profile.setDislikedFoods(user.getDislikedFoods());
        profile.setMaxBudgetPerDay(user.getMaxBudgetPerDay());
        profile.setMaxCookingTimePerMeal(user.getMaxCookingTimePerMeal());
